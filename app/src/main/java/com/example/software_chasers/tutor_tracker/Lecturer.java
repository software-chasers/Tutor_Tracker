...
public class Lecturer extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Lecturer.this, AddCourses.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.profile) {
            Intent intent = new Intent(Lecturer.this, View_profile.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.scan) {
            Intent intent = new Intent(Lecturer.this, Scan_QR_Code.class);
            startActivity(intent);
