...
public class Tutor extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.generate_form) {
            ...
            Intent intent = new Intent(Tutor.this, QR_Code.class);
            intent.putExtra("UserId",userid);
            startActivity(intent);
            return true;
        } else if (id == R.id.view_profile) {
            Intent intent = new Intent(Tutor.this, View_profile.class);
            startActivity(intent);
            return true;
        } else if (id == R.id.apply_to_be_a_tutor) {
            Intent intent = new Intent(Tutor.this, Tutor_application.class);
            startActivity(intent);
            return true;
        }
